...
export const zhCNMessages = {
  ...
  "contentViewer.localAction.copyHint": "打开本地副本；修改不会自动同步到原文件。",
  ...
  "history.refresh": "刷新",
  "history.filter": "筛选",
  "history.filter.agents": "智能体",
  "history.filter.updatedAt": "更新时间",
  "history.agentSelector.all": "全部智能体",
  "history.agentSelector.selectedCount": "已选 {count} 个",
