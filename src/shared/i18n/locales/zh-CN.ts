...
export const zhCNMessages = {
  ...
  "rightSidebar.overview.runInfo.status.question": "等待回答",
  "rightSidebar.overview.runInfo.status.approval": "等待审批",
  "rightSidebar.overview.runInfo.status.form": "等待填写",
  "rightSidebar.overview.runInfo.status.plan": "等待确认",
