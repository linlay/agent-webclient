...
export const zhCNMessages = {
  ...
  "contentViewer.docx.readOnly": "Word · 只读预览",
  "contentViewer.docx.zoom": "缩放",
  "contentViewer.docx.fit": "适应宽度",
  "contentViewer.docx.more": "更多操作",
  "contentViewer.docx.downloadOriginal": "下载原文件",
  "contentViewer.docx.loading": "正在生成 Word 预览…",
  "contentViewer.docx.tooLarge": "文件超过 32 MB，请下载原文件查看。",
  "contentViewer.docx.failed": "无法预览此 Word 文件，文件可能无法访问、已损坏、加密或超过预览限制。可以重试或下载原文件。",
  "contentViewer.docx.retry": "重试",
  "contentViewer.docx.missing": "该文件已不存在，请重新上传后查看。",
  "contentViewer.docx.forbidden": "当前无法访问该文件，请确认登录状态及访问权限。",
  ...
  "history.unread": "未读",
  "history.running": "运行中",
  "history.workerSelector.ariaLabel": "按智能体筛选历史对话",
