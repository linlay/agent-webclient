...
export const zhCNMessages: I18nMessages = {
  ...
  "rightSidebar.diff.current": "当前",
  "rightSidebar.diff.original": "原始",
  ...
  "rightSidebar.review.actions.collapseAll": "全部折叠",
  "rightSidebar.review.actions.expandAll": "全部展开",
  "rightSidebar.review.empty": "暂无代码变更",
  "rightSidebar.review.title": "代码变更评审",
  "rightSidebar.tabs.closeDynamic": "关闭 {title}",
  ...
  "eventPopover.action.viewInjectedPrompt": "查看注入 Prompt",
  ...
  "eventPopover.promptModal.close": "关闭注入 Prompt",
  "eventPopover.promptModal.currentUserMessage": "当前用户消息",
  "eventPopover.promptModal.entries": "注入记录 ({count})",
  "eventPopover.promptModal.historyMessages": "历史消息",
  "eventPopover.promptModal.providerMessages": "发送给模型的消息",
  "eventPopover.promptModal.rawJson": "原始注入 JSON",
  "eventPopover.promptModal.rawPayload": "完整注入载荷",
  "eventPopover.promptModal.summary": "汇总",
  "eventPopover.promptModal.subtitle": "这里展示的是 debug.preCall 中确定会进入模型上下文的提示词视图。",
