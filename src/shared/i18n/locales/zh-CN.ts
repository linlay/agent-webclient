...
export const zhCNMessages = {
  ...
  "selection.fragment.annotations": "{count} 条注释",
  ...
  "skillConsole.list.pinnedGroup": "置顶 {count}",
  "skillConsole.list.otherGroup": "全部技能 {count}",
