...
export const zhCNMessages = {
  ...
  "agents.interaction.model.description": "允许在输入框切换模型",
  "agents.interaction.accessLevel.description": "允许在输入框调整权限级别",
  "agents.interaction.mustUseSkills.description": "允许在输入框指定必用技能",
  "agents.interaction.connectors.description": "允许在输入框启用连接器",
  "agents.interaction.localFiles.description": "允许在输入框附带本地文件",
  "agents.interaction.chatRecords.description": "允许在输入框引用聊天记录",
  ...
  "composer.git.retry": "刷新分支",
  "composer.context.detachedHead": "游离 HEAD",
  "resourceAssistant.editAutomation": "编辑自动化",
  "resourceAssistant.directEdit": "直接编辑",
  "resourceAssistant.conversationEdit": "通过对话编辑",
  "resourceAssistant.sourceEdit": "源文件编辑",
  "resourceAssistant.structuredEdit": "结构化编辑",
  "resourceAssistant.cancelEdit": "取消编辑",
  "resourceAssistant.editAgent": "编辑智能体",
  "resourceAssistant.editSkill": "编辑技能",
  "resourceAssistant.editConnector": "编辑连接器",
  "resourceAssistant.editRegistry": "编辑注册配置",
  "resourceAssistant.manualCreate": "手工创建",
  "resourceAssistant.new": "新增连接器",
  "resourceAssistant.create": "通过对话创建",
  "resourceAssistant.edit": "通过对话修改",
  "resourceAssistant.import": "导入 ZIP",
  "resourceAssistant.kind.automation": "自动化任务",
  "resourceAssistant.kind.skill": "共享技能",
  "resourceAssistant.kind.agent": "智能体",
  ...
  "appearance.skin.default": "默认",
  "appearance.skin.gold": "流金",
  "appearance.skin.blue": "晴澜",
  "appearance.skin.mist": "薄雾",
  "appearance.skin.purple": "紫藤",
  "appearance.package.import": "导入 ZIP 皮肤",
  "appearance.package.remove": "删除当前皮肤",
  ...
  "connectors.skills.list": "技能列表",
  "connectors.skills.empty": "此连接器未附带技能。",
  "connectors.skills.path": "文档路径",
  "connectors.skills.size": "文档大小",
  "connectors.skills.kib": "{size} KiB",
  "connectors.skills.updatedAt": "更新时间",
  "connectors.skills.triggers": "触发词",
  "connectors.skills.document": "技能说明",
  "connectors.skills.preview": "预览",
  "connectors.skills.source": "源码",
  "connectors.sync.unmounted": "未挂载",
  "connectors.sync.unmountedHint": "挂载到 Agent 后开始同步工具。",

  "connectors.auth.title": "账号授权",
  "connectors.auth.status.unknown": "尚未确认",
  "connectors.auth.status.not_required": "无需授权",
  "connectors.auth.status.delegated": "由连接器管理",
  "connectors.auth.status.setup_required": "待准备依赖",
  "connectors.auth.status.unauthorized": "未登录",
  "connectors.auth.status.preparing": "准备登录中",
  "connectors.auth.status.pending": "等待扫码 / 授权",
  "connectors.auth.status.authorized": "已授权",
  ...
  "connectors.auth.checkingHint": "正在获取授权状态…",
  "connectors.auth.checkFailedWithStatus": "{status} · 检查失败",
  ...
  "connectors.import.title": "导入连接器 ZIP 包",
  "connectors.import.select": "选择连接器 ZIP 文件",
  "connectors.import.submit": "导入",
  ...
  "connectors.native.configured": "已配置",
  "connectors.native.unconfigured": "未配置",
  "connectors.native.connect": "完成配置",
  "connectors.native.disconnect": "断开配置",
  "connectors.native.check": "检查配置",
  "connectors.auth.status.configured": "已配置",
  "connectors.auth.description.configured": "已配置",
  "connectors.type.native": "原生",
  "connectors.native.hint": "挂载 Desktop 后提供 desktop_action 和 desktop_cdp。配置完成不代表客户端在线或动作已批准；调用时按 Run 检查客户端、权限及环境限制。KBASE/ACP 不开放，standalone 仅支持既有 WorkPanel/display 动作。",
  "connectors.type.cli": "CLI",
  "connectors.type.mcp": "MCP",
  "connectors.field.id": "ID",
  "connectors.version": "v{version}",
  "connectors.pin": "置顶",
  "connectors.unpin": "取消置顶",
  "connectors.pinFailed": "无法同步连接器置顶，请重试。",
  ...
  "connectors.action.save": "保存配置",
  "connectors.action.more": "{name} 的更多操作",
  "connectors.action.source": "JSON 源码",
  "connectors.action.information": "基本信息",
  ...
  "connectors.field.description": "描述",
  "connectors.field.primaryType": "主类型",
  "connectors.field.auth": "认证方式",
  "connectors.field.bin": "可执行文件",
  "connectors.field.json": "JSON 配置",
  "connectors.field.command": "启动命令",
  "connectors.field.url": "完整服务地址",
  "connectors.field.timeout": "超时（毫秒）",
  "connectors.field.args": "启动参数（每行一项）",
  ...
  "connectors.search": "搜索名称、ID 或技能…",
  "connectors.filter.label": "按组件类型筛选",
  "connectors.filter.all": "全部",
  "connectors.detail.notFound": "找不到连接器：{id}",
  "connectors.detail.empty": "选择一个已安装的连接器，查看组件和配置。",
  "connectors.section.label": "连接器详情",
  "connectors.section.overview": "概览",
  "connectors.section.basics": "基本信息",
  "connectors.section.config": "配置",
  "connectors.section.mcp": "MCP 组件与工具",
  ...
  "connectors.sync.unavailable": "同步失败",
  "connectors.sync.disabled": "已禁用",
  ...
  "agentConsole.resize.listAriaLabel": "调整智能体列表宽度",
  "agentConsole.resize.listTitle": "拖拽调整智能体列表宽度",
  ...
  "agentConsole.mode.kbase.description": "面向知识库浏览与编辑",
  ...
  "automationConsole.action.triggerNow": "立即触发",
  ...
  "automationHistory.action.continueEditing": "继续编辑",
  "automationHistory.action.copyResult": "复制结果",
  "automationHistory.action.discard": "放弃修改",
  "automationHistory.action.edit": "编辑",
  "automationHistory.action.loadMore": "加载更多",
  "automationHistory.action.more": "更多操作",
  "automationHistory.action.moreSettings": "更多设置",
  "automationHistory.action.copyExecutionId": "复制 Execution ID",
  "automationHistory.action.copyRunId": "复制 Run ID",
  ...
  "automationHistory.day.today": "今天",
  ...
  "automationHistory.last.never": "尚未触发",
  "automationHistory.last.label": "上次触发：{time}",
  "automationHistory.message.copied": "已复制",
  "automationHistory.nextFire": "下次触发：{time}",
  "automationHistory.overview.last": "上次结果",
  "automationHistory.overview.next": "下次触发",
  "automationHistory.overview.title": "运行概览",
  "automationHistory.overview.total": "累计触发",
  "automationHistory.preview.empty": "本次运行没有助手输出",
  "automationHistory.preview.running": "正在运行，结果将在完成后显示",
  "automationHistory.result.empty": "本次运行没有可显示的结果。",
  "automationHistory.result.error": "错误信息",
  "automationHistory.result.queryContent": "查看触发 Query",
  "automationHistory.panel.chat": "历史对话",
  "automationHistory.panel.execution": "执行结果",
  "automationHistory.status.canceled": "已取消",
  "automationHistory.status.failed": "失败",
  "automationHistory.status.paused": "已暂停",
  "automationHistory.status.running": "运行中",
  "automationHistory.status.success": "成功",
  "automationHistory.tab.chat": "历史对话",
  "automationHistory.tab.execution": "执行信息",
  "automationHistory.title": "最近触发",
  ...
  "composer.addMenu.section.files": "添加文件",
  "composer.addMenu.section.mode": "模式",
  "composer.addMenu.section.skills": "技能",
  "composer.addMenu.section.connectors": "连接器",
  "composer.addMenu.connectors.back": "返回",
  "composer.addMenu.connectors.search": "搜索连接器",
  "composer.addMenu.connectors.select": "选择 {name}",
  "composer.addMenu.connectors.connectNamed": "连接 {name}",
  "composer.addMenu.connectors.connect": "连接",
  "composer.addMenu.connectors.connecting": "正在连接",
  "composer.addMenu.connectors.loadFailed": "连接器加载失败",
  ...
  "composer.addMenu.site.empty": "没有可引用的站点",
  "composer.addMenu.loading": "正在加载...",
  "composer.addMenu.empty": "没有匹配的内容",
  "composer.addMenu.search.skills": "搜索技能",
  "composer.addMenu.skill.select": "选择 {name}",
  "composer.addMenu.skill.pin": "置顶 {name}",
  "composer.addMenu.skill.unpin": "取消置顶 {name}",
  "composer.addMenu.skill.pinFailed": "无法同步技能置顶，请重试。",
  "composer.addMenu.search.commands": "搜索指令",
  ...
  "selection.sideChat.title": "侧边对话",
  "selection.toolbar.label": "所选文本快捷操作",
  ...
  "composer.background.compact.waiting": "等待当前步骤完成...",
  "composer.background.compact.compacting": "正在压缩上下文...",
  "composer.background.compact.toolsCompacting": "正在压缩工具上下文...",
  ...
  "rightSidebar.overview.runInfo.title": "运行信息",
  "rightSidebar.overview.runInfo.executor": "执行者",
  "rightSidebar.overview.runInfo.model": "模型",
  "rightSidebar.overview.runInfo.context": "上下文",
  "rightSidebar.overview.runInfo.startedAt": "开始",
  "rightSidebar.overview.runInfo.finishedAt": "结束",
  "rightSidebar.overview.runInfo.copyId": "复制 {label}",
  "rightSidebar.overview.runInfo.copyFailed": "复制失败",
  "rightSidebar.overview.runInfo.status.idle": "尚未运行",
  "rightSidebar.overview.runInfo.status.starting": "启动中",
  "rightSidebar.overview.runInfo.status.running": "运行中",
  "rightSidebar.overview.runInfo.status.completed": "已完成",
  "rightSidebar.overview.runInfo.status.cancelled": "已停止",
  "rightSidebar.overview.runInfo.status.error": "失败",
  "rightSidebar.overview.runInfo.status.unknown": "状态待同步",
  "rightSidebar.overview.artifacts.empty": "暂无产物",
  "rightSidebar.overview.artifacts.title": "产物",
  "rightSidebar.overview.artifacts.sortAsc": "按时间升序",
  "rightSidebar.overview.artifacts.sortDesc": "按时间降序",
  ...
  "rightSidebar.overview.planning.sortAsc": "按时间升序",
  "rightSidebar.overview.planning.sortDesc": "按时间降序",
  ...
  "contentViewer.preview.action": "在线预览",
  "contentViewer.preview.tabTitle": "{name} · 在线预览",
  "contentViewer.preview.preparing": "正在准备预览",
  "contentViewer.preview.checking": "正在检查预览服务",
  "contentViewer.preview.unconfigured": "未配置在线预览服务",
  "contentViewer.preview.unsupported": "在线预览仅支持 DOCX、PPTX、XLSX",
  "contentViewer.preview.sourceUnavailable": "此文件来源不支持在线预览",
  "contentViewer.preview.tooLarge": "文件超过在线预览大小限制",
  "contentViewer.preview.invalidResponse": "预览服务响应无效",
  "contentViewer.preview.failed": "无法准备在线预览",
  "contentViewer.preview.back": "返回文件",
  "contentViewer.preview.renew": "重新获取预览",
  "contentViewer.preview.reload": "重新加载",
  ...
  "contentViewer.pdf.next": "下一页",
  "contentViewer.pdf.search": "搜索 PDF",
  "contentViewer.pdf.searchAction": "查找",
  "contentViewer.pdf.found": "已在第 {{page}} 页找到",
  "contentViewer.pdf.notFound": "没有找到匹配内容",
  "contentViewer.annotation.add": "批注选区",
  "contentViewer.annotation.remove": "移除",
  "contentViewer.annotation.invalid": "源文件 revision 变化，批注已失效",
  "contentViewer.annotation.handoff": "交给智能体",
  "contentViewer.annotation.request": "请修改",
  "contentViewer.annotation.previewSelection": "预览选区",
  "contentViewer.image.rotate": "旋转 90°",
  "contentViewer.image.flip": "水平翻转",
  "contentViewer.image.reset": "重置",
  "contentViewer.image.annotationPlaceholder": "描述这个点或区域",
  ...
  "archive.filter.agent": "智能体",
  "archive.filter.agentAll": "全部智能体",
  "archive.filter.archivedDate": "归档日期",
  "archive.filter.ariaLabel": "筛选归档",
  "archive.filter.count": "{filtered} / {total}",
  "archive.filter.createdDate": "创建日期",
  "archive.filter.dateEnd": "结束日期",
  "archive.filter.dateStart": "开始日期",
  "archive.filter.label": "筛选",
  "archive.filter.lastRunDate": "最后运行日期",
  "archive.filter.reset": "重置",
  "archive.list.ariaLabel": "归档对话",
  "archive.resize.listAriaLabel": "调整归档列表宽度",
  "archive.resize.listTitle": "拖拽调整归档列表宽度",
  "archive.restore.failed": "还原失败",
  "archive.restore.result": "已还原归档对话。",
  "archive.restoreConfirm.title": "还原归档对话",
  "archive.search.placeholder": "搜索归档对话",
  "archive.item.more": "更多操作",
  ...
  "leftSidebar.pinned.reorder": "调整置顶顺序：{name}",
  "leftSidebar.pinned.noMatches": "未找到置顶对话",
  ...
  "chatActions.export": "导出为 markdown",
  "chatActions.export.failed": "导出失败",
  "chatActions.export.menu": "导出",
  "chatActions.export.success": "已导出到下载目录",
  "chatActions.exportHtml": "导出为静态 html",
  ...
  "contextCompact.reductionTokens": "本次压缩 {released}%（{tokens} tokens）",
  ...
  "skillConsole.action.deleteSkill": "删除技能",
  "skillConsole.action.download": "下载",
  "skillConsole.action.downloadSkill": "下载技能",
  "skillConsole.action.collapseFileTree": "收起文件列表",
  "skillConsole.action.expandFileTree": "展开文件列表",
  "skillConsole.action.more": "更多",
  "skillConsole.action.pin": "置顶",
  ...
  "skillConsole.action.unpin": "取消置顶",
  "skillConsole.action.validateSkill": "校验技能",
  ...
  "skillConsole.resize.listAriaLabel": "调整技能列表宽度",
  "skillConsole.resize.listTitle": "拖拽调整技能列表宽度",
  "skillConsole.resize.fileTreeAriaLabel": "调整文件树宽度",
  "skillConsole.resize.fileTreeTitle": "拖拽调整文件树宽度",
  "skillConsole.list.title": "技能 {count}",
  ...
  "codeEditor.find.placeholder": "查找",
  "codeEditor.find.replacePlaceholder": "替换",
  "codeEditor.find.toggleReplace": "展开/收起替换",
  "codeEditor.find.caseSensitive": "区分大小写",
  "codeEditor.find.wholeWord": "全词匹配",
  "codeEditor.find.regex": "正则表达式",
  "codeEditor.find.previous": "上一个匹配",
  "codeEditor.find.next": "下一个匹配",
  "codeEditor.find.close": "关闭查找",
  "codeEditor.find.replaceOne": "替换",
  "codeEditor.find.replaceAll": "全部替换",
  "codeEditor.find.noResults": "无匹配结果",
  ...
  "skillConsole.import.submit": "导入 ZIP",
  ...
  "btw.send": "发送",
  "btw.selectionOnlyPrompt": "请结合所选内容给出说明。",
  ...
  "slashPalette.skill.source.agent": "已配置",
  ...
  "chatPreview.title": "聊天预览",
  "chatPreview.empty": "暂无聊天内容",
  "chatPreview.reload": "重新加载",
  "chatPreview.latest": "回到最新",
  "chatPreview.awaiting": "正在等待确认；此页面仅供查看。",
  "chatPreview.ownerMissing": "无法确定运行归属，暂时无法接入实时更新。",
  "chatPreview.identityMismatch": "返回的聊天身份与预览目标不一致。",
  "chatPreview.streamEnded": "实时连接已结束，但尚未确认运行终态，请重新加载。",
  "chatPreview.status.snapshot": "只读 · 历史快照",
  "chatPreview.status.inactive": "只读 · 暂停观察",
  "chatPreview.status.unavailable": "只读 · 更新不可用",
  "chatPreview.status.reconnecting": "只读 · 正在连接",
  "chatPreview.status.running": "只读 · 实时更新",
  "chatPreview.status.history": "只读 · 历史记录",
  "surface.loading": "加载中…",
  ...
  "topNav.usage.compactTools": "压缩工具上下文（L1）",
  "topNav.usage.compactSummary": "生成历史摘要（L2）",
  ...
  "agentConsole.context.searchSkills": "搜索技能…",
  ...
  "agentConsole.budget.importSimple": "导入简易",
  "agentConsole.budget.importAdvanced": "导入高级",
  "agentConsole.budget.template": "模板",
  "agentConsole.budget.template.simple": "简易",
  "agentConsole.budget.template.advanced": "高级",
  ...
  "modalTitleBar.close": "关闭",
  "modalTitleBar.collapse": "收起",
  "history.searchPlaceholder": "搜索对话",
  "history.refresh": "刷新",
  "history.agentSelector.all": "全部智能体",
  ...
  "history.unread": "未读",
  "history.running": "运行中",
  "history.filter.ariaLabel": "筛选历史对话",
  "history.filter.label": "筛选",
  "history.filter.count": "{filtered}/{total}",
  "history.filter.agent": "智能体",
  "history.filter.dateStart": "更新起始日期",
  "history.filter.dateEnd": "更新结束日期",
  "history.filter.reset": "清空筛选",
  ...
  "composer.agent.forbidden": "无权访问当前 Agent",
  "composer.agent.error": "暂时无法确认 Agent 状态，请重试",
