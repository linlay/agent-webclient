...
export const zhCNMessages: I18nMessages = {
  ...
  "eventPopover.action.promptAnalysis": "提示词分析",
  "eventPopover.action.viewInjectedPrompt": "提示词分析",
  ...
  "eventPopover.promptModal.callMetaFallback": "无元数据",
  "eventPopover.promptModal.callTitle": "LLM #{index}",
  "eventPopover.promptModal.calls": "LLM 调用",
  "eventPopover.promptModal.close": "关闭提示词分析",
  "eventPopover.promptModal.currentUserMessage": "当前用户消息",
  "eventPopover.promptModal.empty": "没有找到可分析的提示词内容。",
  "eventPopover.promptModal.entries": "提示词片段 ({count})",
  "eventPopover.promptModal.error": "提示词分析失败：{message}",
  "eventPopover.promptModal.historyMessages": "历史消息",
  "eventPopover.promptModal.loading": "正在加载提示词分析...",
  "eventPopover.promptModal.providerMessages": "发送给模型的消息",
  ...
  "eventPopover.promptModal.title": "提示词分析",
