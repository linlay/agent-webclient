...
export const zhCNMessages = {
  ...
  "automationConsole.section.basic": "基本属性",
  "automationConsole.section.executions": "执行情况",
  ...
  "mcpServers.message.saved": "已保存，watcher 会自动生效，可刷新查看",
  ...
  "mcpServers.tools.empty": "该连接器暂无已归属工具",
  ...
  "composer.addMenu.group.mode": "模式",
  ...
  "composer.addMenu.desktopOnly": "仅 Desktop",
  "composer.addMenu.mode.planning": "Planning 模式",
  "composer.addMenu.mode.editing": "Editing 模式",
  "composer.addMenu.skills.loading": "正在加载 Skills...",
  "composer.addMenu.skills.empty": "没有可用的 Skill",
  "composer.addMenu.skill.requiredBadge": "必须使用",
  "composer.addMenu.skill.requiredTooltip": "本条消息必须使用 {name}",
  ...
  "rightSidebar.preview.text.truncated": "文件内容已截断，下载可查看完整内容。",
  "rightSidebar.preview.unsupported.downloadOnly": "暂不支持预览此文件类型，请下载后查看。",
  ...
  "slashPalette.skill.source.agent": "Agent 已配置",
  "slashPalette.skill.source.market": "技能市场",
  "slashPalette.skill.noDescription": "暂无描述",
  "slashPalette.skills.loading": "正在加载 Skills...",
  "slashPalette.skills.empty": "没有匹配的 Skill",
  "slashPalette.skills.loadFailed": "Skills 加载失败",
