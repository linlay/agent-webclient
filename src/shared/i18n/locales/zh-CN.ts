...
export const zhCNMessages = {
  ...
  "rightSidebar.debug.openChat.copilot": "协作助手（Copilot）",
  ...
  "rightSidebar.debug.tabs.chat": "会话",
  ...
  "copyInfo.group.advanced": "高级信息",
  "copyInfo.group.basic": "基础信息",
  "copyInfo.group.config": "配置信息",
  "copyInfo.group.runtime": "运行与统计",
  ...
  "agentCopy.field.greetings": "问候语",
  "agentCopy.field.wonders": "推荐问题",
  ...
  "agentCopy.field.definition": "完整定义",
  "agentCopy.field.meta": "Meta",
  "agentCopy.field.modelOptions": "模型选项",
  "chatCopy.title": "复制对话信息",
  ...
  "chatCopy.field.activeRunId": "当前 Run ID",
  "chatCopy.field.activeRunAgent": "运行 Agent",
  "chatCopy.field.activeRunStatus": "运行状态",
  "chatCopy.field.model": "模型",
  "chatCopy.field.promptTokens": "输入 Token",
  "chatCopy.field.completionTokens": "输出 Token",
  "chatCopy.field.totalTokens": "总 Token",
  "chatCopy.field.toolCallCount": "工具调用次数",
  "chatCopy.field.llmCallCount": "LLM 调用次数",
  "chatCopy.field.estimatedCost": "预估费用",
  "chatCopy.field.activeRun": "当前 Run",
  ...
  "eventPopover.systemPromptModal.callTitle": "语言模型 #{index}",
  ...
  "leftSidebar.copyAgentInfo": "复制信息",
  ...
  "memoryInfo.field.chatId": "会话 ID（chatId）",
  ...
  "memoryPreview.layer.session": "会话层（session）",
  ...
  "voice.asr.sessionDestroyed": "ASR 调试会话已销毁",
  ...
  "leftSidebar.historyCount": "共 {count} 条会话",
