...
export const zhCNMessages: I18nMessages = {
  ...
  "registryConsole.mcpTools.empty.missingServerKey": "工具摘要未提供 serverKey，暂无法归属显示",
  "registryConsole.mcpTools.empty.noTools": "暂无归属于此 MCP 服务器的工具",
  "registryConsole.mcpTools.section.title": "工具列表 {count}",
  ...
  "copilot.panel.planningPreview": "规划预览",
  "rightSidebar.debug.empty": "暂无事件",
  "rightSidebar.debug.openChat.agent": "Agent",
  "rightSidebar.debug.openChat.agentTitle": "新页面打开 Agent 会话",
  "rightSidebar.debug.openChat.copilot": "Copilot",
  "rightSidebar.debug.openChat.copilotTitle": "新页面打开 Copilot 会话",
  ...
  "globalSearch.action.newConversation": "新建会话",
  "globalSearch.action.history": "历史会话",
  "globalSearch.action.switch": "切换{agentLabel}",
  ...
  "globalSearch.group.conversations": "会话",
  ...
  "skillConsole.delete.confirm": "确定要删除技能 {name} 吗？此操作不可撤销。",
  ...
  "timeline.run.deriveChat": "派生新会话",
  "timeline.run.deriveChatSuccess": "已派生新会话",
  "timeline.run.deriveChatFailed": "派生新会话失败",
