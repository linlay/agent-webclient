...
} from "@/features/debug/lib/eventPopoverCopyMenu";
import {
...
} from "@/features/debug/lib/eventPopoverGrouping";
import {
	formatReadableTimestamp,
	resolveDisplayPayloadTimestamp,
	resolveInitialPopoverState,
	stringifyPopoverPayload,
} from "@/features/debug/lib/eventPopoverFormatters";
import { SystemPromptModal } from "@/features/debug/components/SystemPromptModal";
import {
...
} from "@/features/debug/lib/systemPromptTrace";
...
export const EventPopover: React.FC = () => {
	...
	const rawJsonlTitle =
		copyStatus["rawJsonl"] === "copied"
			? t("eventPopover.feedback.copied", { label: t("eventPopover.label.rawJsonl") })
			: copyStatus["rawJsonl"] === "error"
				? t("eventPopover.feedback.copyFailed", { label: t("eventPopover.label.rawJsonl") })
