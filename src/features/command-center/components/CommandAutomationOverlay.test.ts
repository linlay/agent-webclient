...
import { createCommandOverlayState } from "@/features/command-center/lib/commandOverlay";
...
describe("automation command overlays", () => {
  ...
  it("adapts application state into the shared automation console", () => {
    const html = renderToStaticMarkup(React.createElement(AutomationsRouteContent));
