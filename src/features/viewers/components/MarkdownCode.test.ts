...
import { MarkdownCode } from "@/features/viewers/components/MarkdownCode";
import {
...
} from "@/shared/ui/markdown-code/MarkdownMermaid";

jest.mock("@/shared/ui/markdown-code/index.module.css", () => ({ Collapse: "Collapse" }));
jest.mock("@/shared/ui/markdown-code/highlight-theme.css", () => ({}));
