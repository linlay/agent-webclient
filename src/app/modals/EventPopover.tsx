...
type EventPopoverT = (key: string, params?: Record<string, unknown>) => string;

const defaultEventPopoverT: EventPopoverT = (key, params = {}) => {
...
function buildDefaultCopyMenuItem(t: EventPopoverT): CopyMenuItemState {
  return {
    key: "eventJson",
